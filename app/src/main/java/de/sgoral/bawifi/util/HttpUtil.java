...
public class HttpUtil {
     ...
     * @throws IOException
     */
    public static HashMap<String, String> parseResponse(HttpURLConnection connection, HashMap<String, Pattern> patterns, boolean log) throws IOException {
        Logger.log(HttpUtil.class, "RESPONSE:");
     ...
     * @throws IOException
     */
    public static HttpURLConnection openUrl(Context context, URL url, HashMap<String, String> data) throws IOException {
        Logger.log(HttpUtil.class, "Opening url '" + url.toString() + "'");
        ...
        Logger.log(HttpUtil.class, "Response: " + connection.getResponseCode());
